  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col items-center gap-6">
        <div className="w-full max-w-lg bg-white dark:bg-slate-800/80 rounded-2xl border border-amber-200 dark:border-amber-800/40 overflow-hidden shadow-sm">
          <div className="bg-gradient-to-r from-amber-500 to-orange-500 px-5 py-4">
            <h3 className="text-white font-semibold flex items-center gap-2">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4.5c-.77-.833-2.694-.833-3.464 0L3.34 16.5c-.77.833.192 2.5 1.732 2.5z" />
              </svg>
              Ambigüedad del Contador de Programa
            </h3>
          </div>
          <div className="p-5 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-[15px]">
                En arquitecturas complejas, el fallo puede ocurrir en cualquier punto. El Contador de Programa puede apuntar a lugares intermedios.
              </p>
            </div>
            <div className="flex items-start gap-3">
          ...
          <div className="bg-white dark:bg-slate-800/80 rounded-2xl border border-emerald-200 dark:border-emerald-800/40 overflow-hidden shadow-sm">
            ...
            <div className="p-5 space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-[15px]">
                  Registros ocultos que guardan copia exacta del Contador de Programa antes de cada instrucción.
                </p>
              </div>
              <div className="flex items-start gap-3">
